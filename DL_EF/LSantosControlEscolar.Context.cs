...
namespace DL_EF
{
    ...
    public partial class LSantosControlEscolarEntities : DbContext
    {
        public LSantosControlEscolarEntities()
            : base("name=LSantosControlEscolarEntities")
        {
        }
        ...
        public virtual int AlumnoUpadate(Nullable<int> idAlumno, string nombre, string apellidoPaterno, string apellidoMaterno)
        {
            var idAlumnoParameter = idAlumno.HasValue ?
                new ObjectParameter("IdAlumno", idAlumno) :
                new ObjectParameter("IdAlumno", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AlumnoUpadate", idAlumnoParameter, nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter);
        }
